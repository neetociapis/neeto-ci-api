...
description: "Learn how to authenticate your requests to the NeetoCI API using API keys."
---

### Generating an API Key

To use the NeetoCI APIs, you must first generate an API key.
[Learn how to generate your API key here.](https://help.neetoci.com/articles/api-keys)
...
```bash
curl https://{your-subdomain}.neetoci.com/api/external/v1/jobs \
...
<CodeGroup>
```bash .env
NEETOCI_API_KEY=your_api_key_here
NEETOCI_WORKSPACE=your-workspace
```

```javascript JavaScript
// Load from environment
const apiKey = process.env.NEETOCI_API_KEY;
const workspace = process.env.NEETOCI_WORKSPACE;
```

```python Python
import os

api_key = os.getenv('NEETOCI_API_KEY')
workspace = os.getenv('NEETOCI_WORKSPACE')
```
